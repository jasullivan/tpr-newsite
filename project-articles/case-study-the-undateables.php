    ...
    <article role="article">
        ...
        <header class="container-fluid pt-4">
            <div class="tpr-blue-bar">
                <h1 class="tpr-blue-bar__content">Case Study: The Undateables</h1>
            </div>
        </header>
        <!-- blue header bar -->
                ...
                <div class="col-9 mx-auto">
                    <div class="tpr-article-content">
                        <img 
                            data-sizes="auto"
                            data-srcset="
                                ../assets/images/projects/the-undateables-med.jpg 800w, 
                                ../assets/images/projects/the-undateables-lrg.jpg"
                            data-src="../assets/images/projects/the-undateables-med.jpg"
                            src="../assets/images/projects/the-undateables-preview.jpg" 
