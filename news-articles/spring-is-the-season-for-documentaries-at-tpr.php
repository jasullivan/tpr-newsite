    ...
    <article role="article">
        ...
        <header class="container-fluid pt-4">
            <div class="tpr-blue-bar">
                <h1 class="tpr-blue-bar__title">Spring is the season for documentaries at tpr with three thought-provoking programmes hitting screens in one week</h1>
            </div>
        </header>
        <!-- blue header bar -->
            ...
            <div class="row">
                <div class="col-11 col-lg-9 mx-auto">
                    <div class="next-prev-buttons pt-4">
                        <a href="itv4s-new-signing-warren-united-takes-to-the-big-screen-for-debut" class="next-prev-buttons__prev">
                            <span class="icon-arrowLeft"></span>previous
                        </a>
                        <a href="tima-hosts-the-launch-of-aib-2014-awards" class="next-prev-buttons__next">
                ...
                <div class="col-11 col-lg-9 mx-auto">
                    <div class="tpr-article-content">
                        ...
                        <img 
                            data-sizes="auto" 
                            data-srcset="
                                ../assets/images/news/channel-four-last-chance-school-news_400w.jpg 400w, 
