            ...
            <div class="row">
                <div class="col-11 col-lg-9 mx-auto">
                    <div class="next-prev-buttons pt-4">
                        ...
                        <a href="the-kogi" class="next-prev-buttons__next">
            ...
            <div class="row">
                <div class="col-11 col-lg-9 mx-auto">
                    <div class="tpr-article-content">
                        ...
                        <p class="tpr-article-content__paragraph">Friday 15 June at 17.45, Showroom 2</p>

                        <p class="tpr-article-content__paragraph">Sunday 17 June at 12.45, Showroom 1</p>

                        <p class="tpr-article-content__paragraph">Two Kogi will be coming to Sheffield for the screenings, so this should be a very special event indeed.</p>

                        <p class="tpr-article-content__paragraph">For more info, contact Sophie on <a class="tpr-article-content__link" href="mailto:sophie@tpr-media.com" rel="noopener">sophie@tpr-media.com</a> / 020 8347 7020</p>
