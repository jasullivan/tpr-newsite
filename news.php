    ...
    <div class="container">
        ...
        <div class="row tpr-news-row pt-5 pb-3 no-gutters">
            <div class="col-xl-8 pr-xl-3">
                <img data-src="./assets/images/news/andre_simon_2019-news.jpg" src="./assets/images/news/andre_simon_2019-news-preview.jpg" alt="Diana Henry and Meera Sodha at the André Simon Food and Drink book awards for 2018" class="tpr-news-row__image lazyload">
            </div>
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    <h2 class="tpr-news-row__title">Andr&#233; Simon Food &amp; Drink Awards reveal the winners for 2019</h2>
                    <p class="tpr-news-row__paragraph">Last Monday (20 January) the Andr&#233; Simon Food &amp; Drinks Awards took place at the Goring Hotel in London. For over 40 years, they have been celebrating the very best in contemporary food and drink writing, and we’re pleased to say that tpr media has been with the awards for six years.</p> 
                    <a href="news-articles/andre-simon-award-winners-2019" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    <h2 class="tpr-news-row__title">Winners of the AHRC Research in Film Awards 2019 announced</h2>
                    <p class="tpr-news-row__paragraph">Team tpr had a great time on Tuesday night (12 November), at the BFI Southbank where the fifth annual Research in Film Awards organised by the Arts and Humanities Research Council (AHRC) took place. These are the only awards entirely dedicated to showcasing the breadth of research in arts and humanities through film and five winners were selected from hundreds of submissions and a strong short-list.</p>
                    <a href="news-articles/winners-of-ahrc-research-in-film-awards-2019" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
                <img data-src="./assets/images/news/winners-of-ahrc-news.jpg" src="./assets/images/news/winners-of-ahrc-news-preview.jpg"
                    alt="Rooftop view of Piet Oudolf's garden in Hummelo." class="tpr-news-row__image lazyload">
            </div>
        </div>

        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-8 pr-xl-3">
                <img data-src="./assets/images/news/under-the-knife-film-news.jpg" src="./assets/images/news/under-the-knife-film-news-preview.jpg" alt="Under the Knife film" class="tpr-news-row__image lazyload">
            </div>
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    <h2 class="tpr-news-row__title">NHS film 'Under the Knife' premieres with support from Ken Loach and Alison Steadman</h2>
                    <p class="tpr-news-row__paragraph">#itsworthsaving @UTKNHS @keepnhspublic @DailyMirror</p>
                    <p class="tpr-news-row__paragraph">Under the Knife, NHS feature-length documentary, premiered on Thursday 19 September in London. The provocative film is being screened for free in over 50 venues across the UK. Anyone who wants to save the NHS must see this film. To book free tickets visit: <a href="https://undertheknifefilm.co.uk/screenings/" target="_blank">undertheknifefilm.co.uk/screenings.</a></p> 
                    <a href="news-articles/nhs-film-under-the-knife-premier" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    <h2 class="tpr-news-row__title">New slate of projects for tpr media this spring</h2>
                    <p class="tpr-news-row__paragraph">I'm delighted to tell you about two new projects we’re working on this spring: the Great Exhibition Road Festival in South Kensington, London (28-30 June), and the UK cinema release (from 14 June) of Five Seasons: The Gardens of Piet Oudolf, a film about the visionary Dutch landscape designer.</p>
                    <a href="news-articles/new-slate-of-projects-for-tpr-media-this-spring" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
                <img data-src="./assets/images/news/five-seasons-news.jpg" src="./assets/images/news/five-seasons-news-preview.jpg"
                    alt="Rooftop view of Piet Oudolf's garden in Hummelo." class="tpr-news-row__image lazyload">
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    home cooking.</p>
                    <a href="news-articles/diana-henry-at-andre-simon-awards" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    ...
                    <p class="tpr-news-row__paragraph">It was great to be contacted last week by Catherine Allen, a BAFTA-winning immersive media specialist and founder of Limina Immersive. She approached tpr media to promote an exciting VR-only arts festival, Limina VR Weekender, which is taking place at Picturehouse Central this weekend (1&amp;2 December 2018).</p>
                    <a href="news-articles/vr-is-for-everyone" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    <p class="tpr-news-row__paragraph">We were privileged to have been involved in the release of Dartmouth Films' new documentary The Ballymurphy Precedent in UK and Irish cinemas and Channel 4 this Sunday (9 September), directed by Callum Macrae.</p>
                    <a href="news-articles/dartmouth-films-new-documentary" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    ...
                    <a href="news-articles/storyville-docs" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    <a href="news-articles/inside-dior" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    ...
                    attended.</p>
                    <a href="news-articles/remember-baghdad" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    <a href="news-articles/aljazeera-launches-web-app" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    ...
                    <a href="news-articles/nhk-world-tv" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    <a href="news-articles/tpr-loves-docs" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    ...
                    <a href="news-articles/last-whites-of-east-end" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    <a href="news-articles/jamie-oliver-at-andre-simon-awards" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            <div class="col-xl-4 order-2 order-xl-1 pr-xl-3">
                <section class="tpr-news-row__content px-5 py-5">
                    ...
                    <a href="news-articles/artists-against-ttip" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
            <div class="col-xl-8 order-1 order-xl-2">
        ...
        <div class="row tpr-news-row pb-3 no-gutters">
            ...
            <div class="col-xl-4">
                <section class="tpr-news-row__content tpr-news-row__content--grey px-5 py-5">
                    ...
                    <a href="news-articles/millenials-and-mobiles" class="btn tpr-button mt-4">Read More</a>
                </section>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="archive-projects">
                    <li class="archive-projects__link"><a href="news-articles/happy-anniversary-tima"><h3>Happy anniversary TIMA, marking three years in Washington DC</h3></a></li>
                    <li class="archive-projects__link"><a href="news-articles/tpr-at-hyper-japan"><h3>tpr media at Hyper Japan 2015</h3></a></li>
                    <li class="archive-projects__link"><a href="news-articles/reuters-tima-launch"><h3>Reuters-TIMA Penthouse Launch Party</h3></a></li>
                    <li class="archive-projects__link"><a href="news-articles/andre-simon-award-winners"><h3>Congratulations to the Andr&#233; Simon Food and Drink Award Winners</h3></a></li>
                    <li class="archive-projects__link"><a href="news-articles/no-fire-zone-released-sinhala"><h3>No Fire Zone released in Sinhala</h3></a></li>
